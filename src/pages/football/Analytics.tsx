...
export default function FootballAnalytics() {
  const [selectedMetrics, setSelectedMetrics] = useState<string[]>(["xgContribution", "pressingImpact", "buildUpValue"]);
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground text-sm mt-1">Advanced football metrics and analysis</p>
      </div>
      <AnalyticsSelector sport="football" selectedMetrics={selectedMetrics} onMetricsChange={setSelectedMetrics} chartType={chartType} onChartTypeChange={setChartType} selectedCategory={selectedCategory} onCategoryChange={setSelectedCategory} />
